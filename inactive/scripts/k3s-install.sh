...
read -r -p "[k3s-install] input a tag (leave blank to use latest stable): " TEMP_VERSION
read -r -p "[k3s-install] enter any character/string to NOT copy config to ~/.kube/config (leave blank to skip): " DECLINE
